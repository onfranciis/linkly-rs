...
requests, discussions, and any other project communication channels), and also
...
reported to the maintainer at [hello@onfranciis.dev](mailto:hello@onfranciis.dev).
